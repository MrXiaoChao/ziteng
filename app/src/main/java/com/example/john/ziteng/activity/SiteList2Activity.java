 ...
 */
public class SiteList2Activity extends BaseActivity implements View.OnClickListener {
    ...
    private SiteListAdapter2 adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPhone = (String) SPUtils.get(SiteList2Activity.this, "phone", "");
        initImageLoader();
        getPidFromService();
        initview();
    ...
    private void initview() {
        ...
        listView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                ...
                a = listtotal.size() - list.size() + 1;//上拉加载之后所要定的位置
    ...
    private void getInfoFromService(final int page) {
        StringRequest request = new StringRequest(Request.Method.POST, Path.SiteListTD, new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                ...
                if (siteLists != null) {
                    ...
                    if (list != null) {
                        ...
                        adapter = new SiteListAdapter2(SiteList2Activity.this, listtotal);
                        if (adapter != null) {
                    ...
                    Toast.makeText(SiteList2Activity.this, "暂无数据", Toast.LENGTH_SHORT).show();
                }
            }
