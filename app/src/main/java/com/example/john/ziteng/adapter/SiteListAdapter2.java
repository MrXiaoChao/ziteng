 ...
 */
public class SiteListAdapter2 extends BaseAdapter {
    private ArrayList<SiteListInfo> list;
    private Context context;


    public SiteListAdapter2(Context context, ArrayList<SiteListInfo> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.item_sitelist2, null);
