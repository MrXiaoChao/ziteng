...
public class ChangPasswordActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPhone = (String) SPUtils.get(ChangPasswordActivity.this, "phone", "");
        initview();
    }
    ...
    private void getDateFromService() {
        StringRequest request = new StringRequest(Request.Method.POST, Path.ChangPassWord, new Response.Listener<String>() {
            @Override
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("data.controlPWD", passWordnew2);
